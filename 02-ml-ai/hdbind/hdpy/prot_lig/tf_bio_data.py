...
class Featurizer:
    ...
    def __init__(
        ...
        if named_properties is not None:
            ...
            #                    'partialcharge']
            # heavyvalence was renamed to heavydegree, heterovalence to heterodegree
...
def featurize_pybel_complex_md(ligand_mol, pocket_mol):
    ...
    # NOTE: also don't need to get the coords because we're looking at trajectories and these don't describe the system of interest

    data = np.concatenate((ligand_features, pocket_features))
