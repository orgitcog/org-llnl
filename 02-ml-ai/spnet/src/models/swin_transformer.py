...
class ShiftWindowMSA(BaseModule):
    ...
    def window_reverse(self, windows, H, W):
        ...
        x = windows.view(B, H // window_size, W // window_size, window_size,
                         window_size, last_dim)
        x = x.permute(0, 1, 3, 2, 4, 5).contiguous().view(B, H, W, last_dim)
        return x
...
class SwinTransformer(BaseModule):
    ...
    def __init__(self,
        ...
        # classifier head (used for LWF)
        self.norm = build_norm_layer(norm_cfg, self.num_features[-1])[1]
