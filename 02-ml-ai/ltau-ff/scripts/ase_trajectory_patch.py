# For LTAU-FF, this file should replace ase/io/trajectory.py
import warnings
...
class TrajectoryWriter:
    ...
    def _write_atoms(self, atoms, **kwargs):
        ...
        if calc is not None:
            ...
            for prop in all_properties+self.properties:
                if prop in kwargs:
                    x = kwargs[prop]
                else:
...
class TrajectoryReader:
    ...
    def __init__(self, filename, properties=None):
        ...
        Args:
            filename: str, the filename traditionally ends in .traj.
            properties: list[str], additional properties which should be read
                from the file
        """
