...
with open(os.path.join(this_directory, 'efficientse3', '_version.py'), 'wt') as fversion:
...
setuptools.setup(
    name="efficientse3",                                           # name of project
    ...
    author="Hunter Nisonoff, Shikai Qui",                                     # Author, shown on PyPI
