...
class Voxelizer3D(nn.Module):
    def __init__(self, feat_dim=19, vol_dim=48, ang_size=48, relative_size=True, atom_radius=1, verbose=0):
...
class GaussianFilter(nn.Module):
    def __init__(self, dim=2, channels=3, kernel_size=11, sigma=1):
