...
This directory contains the materials for the HPCIC 2025 tutorial. The following subsections go over the contains of the material.
...
like :code:`ghcr.io/llnl/benchpark:hpcic-2025`. Note that :code:`<iamge_name>` **must** match the value of the :code:`FROM` directive
