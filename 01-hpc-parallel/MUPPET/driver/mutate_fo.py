...
if __name__ == '__main__':
    ...
    result = skopt.forest_minimize(func=test_func, dimensions=dimensions, n_calls=total_tests, \
                    n_initial_points=10, \
                    acq_func="LCB", kappa=1.6, base_estimator="RF", random_state=randomSeed, callback=func_callback)
    ...
    check.printstats("_fo", args.program, avg_runtime, plugin_time, run_time, total_time)
