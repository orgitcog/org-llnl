...
```
tioga12    Task   0/  1 running on 6 CPUs: 48-50,112-114
```
</details>
...
### 2. Using explicit binding, map a program with 4 tasks as follows: the first three tasks map to the first 3 cores on the first NUMA domain, one task per core; and the last task maps to all cores on the second NUMA domain.
