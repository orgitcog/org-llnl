...
#if 1 /// 2004/11/11 // c
#ifndef _THREAD_ALLOW_INIT_PARTS
#define _THREAD_ALLOW_INIT_PARTS
%{
  //SWIGDEBUG  
...
#endif // _THREAD_ALLOW_INIT_PARTS
#endif // 2004/11/11 //c
...
%typemap(throws) wxString {
  //SWIGDEBUG  %typemap(throws) wxString
	PyThreadState *tstate;
...
%#endif
	...
	//2004/03/30-throwWxString   PyObject* s = wx2PyString( $1 );
    //2004/03/30-throwWxString   PyErr_SetObject(PyExc_RuntimeError, s);
	//2004/03/30-throwWxString   Py_DECREF(s);
	wxPyEndAllowThreads(tstate);
