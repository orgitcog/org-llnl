...
# PYPATH_DIR ?= /cygdrive/c/cygwin/home/haase/PrCyg/Priithon
# >>> N.get_numpy_include()
# 'C:\PrWin24\numpy\core\include'
# >>> 
...
PYHOME?=/cygdrive/c/python$(PYVER_NODOT)
...
%.o: %.cpp
	$(CXX) -Wall -DUSE_DL_IMPORT $(OPT_FLAGS) $(CXXFLAGS) $(INCL) $(INC_PY) -c $<
...
SWIG?=${PRI}/_swig/swig.bat
# SWIGDIR=c:/cygwin/home/haase/swigwin-1.3.31
# SWIG=$(SWIGDIR)/swig -I$(SWIGDIR)/Lib/python -I$(SWIGDIR)/Lib \
#     -I${PRCOMMON} -I${PRCOMMON}/Include

#20070915 SWIG=swig -I${PRCOMMON} -I${PRCOMMON}/Include
...
INC_PY = -D_WIN32  -DWIN32 -I$(PYHOME)/include/ -I${PRCOMMON} -I${PRCOMMON}/Include
...
$(SWIG_OBJ):  $(SWIG_CXX)
	...
	$(CXX)  -Wall $(OPT_FLAGS) -c $< $(CXXFLAGS) $(INCL) $(INC_PY)
