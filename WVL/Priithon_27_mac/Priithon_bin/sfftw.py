...
if version_info >= (2,6,0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_sfftw', [dirname(__file__)])
        except ImportError:
            import _sfftw
            return _sfftw
        if fp is not None:
            try:
                _mod = imp.load_module('_sfftw', fp, pathname, description)
            finally:
                fp.close()
                return _mod
    _sfftw = swig_import_helper()
...
def rfftw(*args):
  """
    rfftw(rfftw_plan plan, int howmany, fftw_real _in, int istride, 
...
def rfftw_one(*args):
  """rfftw_one(rfftw_plan plan, fftw_real _in, fftw_real out)"""
...
def rfftwnd_one_real_to_complex(*args):
  """rfftwnd_one_real_to_complex(rfftwnd_plan p, fftw_real _in, fftw_complex out)"""
  return _sfftw.rfftwnd_one_real_to_complex(*args)

def rfftwnd_one_complex_to_real(*args):
  """rfftwnd_one_complex_to_real(rfftwnd_plan p, fftw_complex _in, fftw_real out)"""
  return _sfftw.rfftwnd_one_complex_to_real(*args)

def fftw_sizeof_fftw_real():
  """fftw_sizeof_fftw_real() -> size_t"""
  return _sfftw.fftw_sizeof_fftw_real()
...
def fftwnd_one(*args):
  """fftwnd_one(fftwnd_plan p, fftw_complex _in, fftw_complex out)"""
