...
std::string to_string(CalibrationMsg::EventType et)
{
    switch (et)
    {
        case CalibrationMsg::EventType::start:
            return "start";
        case CalibrationMsg::EventType::success:
            return "success";
        case CalibrationMsg::EventType::constrained_success:
            return "success (constrained)";
        case CalibrationMsg::EventType::failure:
            return "failure";
    }
    return "<UNKNOWN>";
}
