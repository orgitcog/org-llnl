...
template <class Size_T>
void *SmallVectorBase<Size_T>::replaceAllocation(void *NewElts,
                                                 size_t TSize,
                                                 size_t NewCapacity,
                                                 size_t VSize)
{
...
// Note: Moving this function into the header may cause performance regression.
template <class Size_T>
void *SmallVectorBase<Size_T>::mallocForGrow(void *FirstEl,
                                             size_t MinSize,
                                             size_t TSize,
                                             size_t &NewCapacity)
{
  ...
  if (!NewElts) throw std::bad_alloc();
...
template class ams::SmallVectorBase<uint32_t>;
...
template class ams::SmallVectorBase<uint64_t>;
