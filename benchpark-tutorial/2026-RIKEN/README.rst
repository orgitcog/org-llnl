...
This directory contains the materials for the RIKEN 2026 tutorial. The following subsections go over the contains of the material.
...
like :code:`ghcr.io/llnl/benchpark:riken-2026`. Note that :code:`<image_name>` **must** match the value of the :code:`FROM` directive
