...
This directory contains the materials for the latest tutorial. The following subsections go over the contains of the material.
...
like :code:`ghcr.io/llnl/benchpark:latest`. Note that :code:`<iamge_name>` **must** match the value of the :code:`FROM` directive
