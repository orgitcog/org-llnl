...
# set(HIP_HIPCC_FLAGS "-D__HIP_ROCclr__ -D__HIP_PLATFORM_AMD__ -DCAMP_USE_PLATFORM_DEFAULT_STREAM -D__HIP_ARCH_GFX90A__=1 --rocm-path=/opt/rocm-6.2.1 -std=c++17 -x hip --offload-arch=gfx90a" CACHE STRING "")
...
set(CMAKE_CXX_FLAGS "-std=c++17 --cuda-gpu-arch=gfx90a" CACHE STRING "")
...
set(HIP_HIPCC_FLAGS "-D__HIP_ROCclr__ -D__HIP_PLATFORM_AMD__ -DCAMP_USE_PLATFORM_DEFAULT_STREAM -std=c++17 -x hip --gpu-arch=gfx90a" CACHE STRING "")
