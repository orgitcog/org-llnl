...
struct finite_element<mfem::Geometry::SQUARE, L2<p, c> > {
  ...
  */
  ...
  template <int q>
  SMITH_HOST_DEVICE static auto interpolate([[maybe_unused]] const dof_type_if& X,
  ...
  template <typename T, int q>
  SMITH_HOST_DEVICE static void integrate(const tensor<tuple<T, T>, q * q>& qf_output,
