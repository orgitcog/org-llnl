...
OPEN_INFO = {
    ...
    (II, 0, 1, 2, (1,), ()): ("1", "1;IR"),
    (II, 0, 1, 1, (8,), ()): ("L", "L;I"),
    (II, 0, 1, 1, (16,), ()): ("I;16", "I;16"), #seb: Typhoon fluorescence scanner
    (II, 0, 1, 2, (8,), ()): ("L", "L;IR"),
    (II, 1, 1, 1, (1,), ()): ("1", "1"),
    (II, 1, 1, 2, (1,), ()): ("1", "1;R"),
    (II, 1, 1, 1, (8,), ()): ("L", "L"),
    ...
    (II, 1, 2, 1, (32,), ()): ("I", "I;32S"),
    (II, 1, 3, 1, (32,), ()): ("F", "F;32F"),
    (II, 2, 1, 1, (8,8,0), ()): ("RGB", "RGB"),#seb -- found in LSM(Zeiss) files
    #(II, 2, 1, 1, (16,16,16), ()): ("RGB", "RGB"),#seb -- found in LSM(Zeiss) files
    #seb jeff's (II, 2, 1, 1, (8,8,8,8), ()): ("RGBX", "RGBX"),#seb -- found in LSM(Zeiss) files
    ...
    (MM, 0, 1, 2, (1,), ()): ("1", "1;IR"),
    (MM, 0, 1, 1, (8,), ()): ("L", "L;I"),
    (MM, 0, 1, 1, (16,), ()): ("I;16", "I;16"), #seb: Typhoon fluorescence scanner
    (MM, 0, 1, 2, (8,), ()): ("L", "L;IR"),
    (MM, 1, 1, 1, (1,), ()): ("1", "1"),
    (MM, 1, 1, 2, (1,), ()): ("1", "1;R"),
    (MM, 1, 1, 1, (8,), ()): ("L", "L"),
    ...
    def _setup(self):
        ...
        if self.mode == "P":
            try:
                ...
                # seb HACK !! for some Zeiss LSM files
                palette = map(lambda a: chr(a // 256), range(256))
            #seb(inserted try-except) orig: palette = map(lambda a: chr(a / 256), self.tag[COLORMAP])
