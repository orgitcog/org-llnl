...
class mockNDarray(object):
    ...
    def _mockAxisSet(self, i):
        ...
        # fixup the self._shape to reflext the "biggest" shape possible, like a "convex hull"
    ...
    def __setitem__(self, idx, val):
        if isinstance(idx, int):
            ...
            if isinstance(mockIdx, slice):
                ...
                self._arrs[mockIdx][idxSkipMock] = val
        ...
        raise IndexError, "cannot handle index type" 
