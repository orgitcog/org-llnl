...
class viewerRubberbandMode:
    def __init__(self, id=-1, rubberWhat='box', color=(0,1,0), 
        ...
        Y.registerEventHandler(self.viewer.doOnLDown, newFcn=self.onLeft1, newFcnName='vLeftClickDoes', oldFcnName=None)
    ...
    def onLeft1(self, xEff, yEff, ev):
        ...
        from .all import Y
        Y.registerEventHandler(self.viewer.doOnLDown, newFcn=self.onLeft2, newFcnName='vLeftClickDoes')
        Y.registerEventHandler(self.viewer.doOnMouse, newFcn=self.onMove, newFcnName='vLeftClickDoes', oldFcnName=None)
    ...
    def onLeft2(self, xEff, yEff, ev):
        ...
        Y.registerEventHandler(self.viewer.doOnLDown, oldFcnName='vLeftClickDoes')
        Y.registerEventHandler(self.viewer.doOnMouse, oldFcnName='vLeftClickDoes')
