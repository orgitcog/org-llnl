...
for i in $(seq 1 6); do 
  nohup ../../compgpt.bin --config=gpt4o_guided.json --csvsummary=gpt4o_guided.csv $srcfile
  ./save-experiment.sh gpt4o.guided.$i
  ./clean.sh

  nohup ../../compgpt.bin --config=gpt4o_unguided.json --csvsummary=gpt4o_unguided.csv $srcfile
