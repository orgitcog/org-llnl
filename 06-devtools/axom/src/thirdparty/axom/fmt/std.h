...
#ifdef AXOM_FMT_CPP_LIB_FILESYSTEM
...
#ifdef AXOM_FMT_CPP_LIB_VARIANT
// Use the provided definition.
...
#  elif AXOM_FMT_MSC_VERSION && defined(_MSVC_STL_UPDATE)
  return normalize_msvc_abi_name(ti.name(), out);
#  elif AXOM_FMT_MSC_VERSION && defined(_LIBCPP_VERSION)
...
#if defined(_LIBCPP_VERSION) && !defined(AXOM_FMT_IMPORT_STD)
template <typename C>
