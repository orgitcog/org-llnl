...
class ostream : private detail::buffer<char> {
 private:
  ...
  AXOM_FMT_API ostream(cstring_view path, const detail::ostream_params& params);

  AXOM_FMT_API static void grow(buffer<char>& buf, size_t);

 public:
  AXOM_FMT_API ostream(ostream&& other) noexcept;
  AXOM_FMT_API ~ostream();
