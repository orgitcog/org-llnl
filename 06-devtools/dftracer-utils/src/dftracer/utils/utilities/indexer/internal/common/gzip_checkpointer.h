#ifndef DFTRACER_UTILS_UTILITIES_INDEXER_INTERNAL_COMMON_GZIP_CHECKPOINTER_H
#define DFTRACER_UTILS_UTILITIES_INDEXER_INTERNAL_COMMON_GZIP_CHECKPOINTER_H
...
#endif  // DFTRACER_UTILS_UTILITIES_INDEXER_INTERNAL_COMMON_GZIP_CHECKPOINTER_H
