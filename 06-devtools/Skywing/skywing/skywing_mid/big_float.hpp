...
public:
    ...
    friend inline BigFloat operator+(const BigFloat& a, const BigFloat& b)
    {
        if (a.fraction_ == 0)
            return b;
        if (b.fraction_ == 0)
    ...
    friend inline BigFloat& operator+=(BigFloat& a, const BigFloat& b)
    {
        a = a + b;
        return a;
    }

    friend inline BigFloat operator-(const BigFloat& a)
    {
    ...
    friend inline BigFloat operator*(double d, const BigFloat& a)
    {  
        return BigFloat(a.exp_, d * a.fraction_);
    }

    friend inline BigFloat operator/(const BigFloat& a, double d)
    {
    ...
    friend inline std::ostream& operator<<(std::ostream& out, const BigFloat& b)
    {
        out << b.fraction_;
        out << "*2^";
        out << b.exp_;
     ...
     * so.
     */
    friend inline BigFloat pow2(const BigFloat& input)
    {
     ...
     */
    friend inline BigFloat log2(const BigFloat& input)
    {
     ...
     */
    friend inline BigFloat exp(const BigFloat& input)
    {
     ...
     */
    friend inline BigFloat log(const BigFloat& input)
    {
