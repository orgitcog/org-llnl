...
Contour plots to visualize x and y momentum of grains in the x-y plane.
...
print('Visualize Momentum Perturbations')
...
for parameter in parameters:
    ...
    titles = ["Normalized x-Momentum\n" + r"Perturbation $\delta p_x / (\rho_2 a_2)$", 
              "Normalized y-Momentum\n" + r"Perturbation $\delta p_y / (\rho_2 a_2)$",
              r"Density Perturbation $\delta\rho / \rho_2$"]
    zs = [sim.tilde_Mx(t, x_grid, y_grid), 
          sim.tilde_My(t, x_grid, y_grid), 
    ...
    # zs = [sim.tilde_momx(t, x_grid, y_grid), 
    #       sim.tilde_momy(t, x_grid, y_grid), 
    ...
    savename = "plots/momentum/" + investigation + "/Ls-" + str(Ls)
