...
class Zika(Dataset):
    ...
    def __init__(
        ...
        file_path = os.path.join(data_dir, "zika-"+configs["pocket"]+".hdf")
    ...
    def __getitem__(self, item):
        ...
        if "graph" in self.input_type:
            ...
            _data.pos = pos
            _data.label = torch.tensor([[1., 0.]]) if y == 0 else torch.tensor([[0., 1.]])
