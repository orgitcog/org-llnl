...
Once a replay tool is associated with the instrument and the sampled spectra have been generated for a scenario, highlighting both the instrument/replay combination and at least one scenario in the main RASE window makes the “Run Replay Tool” button available to the user.
